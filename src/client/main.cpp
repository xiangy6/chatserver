...
string getCurrentTime();// 获取系统时间（聊天信息需要添加时间信息）
...
int main()
{
    ...
    server.sin_addr.s_addr = inet_addr("192.168.28.4");
    ...
    else // 登录成功
    {
        ...
        if (responsejs.contains("groups"))
        {
            ...
            for (string &groupstr : vec1)
            {
                ...
                group.setgpname(grpjs["groupname"]);
                group.setgpdesc(grpjs["groupdesc"]);
...
void showCurrentUserData()
{
    ...
    if (!g_currentUserGroupList.empty())
    {
        ...
        {
            cout << group.getid() << " " << group.getgpname() << " " << group.getgpdesc() << endl;
